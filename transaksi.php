    ...
    <div class="container mt-5">
        ...
        <form method="POST" class="p-4 border rounded bg-light">
            ...
            <div class="mb-3" style="display: flex; align-items:center;">
                ...
                <input type="number" class="form-control" name="durasi" min="1" value="<?= $durasi ?>" style="width: 80px; margin-left:10px; text-align:center;" required>
                <span style="margin-left: 5px;">Hari</span>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <?php endif; ?>
                <a href="beranda.php" class="btn btn-danger w-50">Cancel</a>
            </div>
        </form>
